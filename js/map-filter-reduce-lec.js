...
let low = products.filter(prices => prices.price < 50)
console.log("Items under $50: ",low )
...
let reducedPrice = products.reduce((previousVal, currentVal) => {
    console.log(previousVal)
    console.log(currentVal)
    if(currentVal.price < 50) {
        console.log(previousVal)
